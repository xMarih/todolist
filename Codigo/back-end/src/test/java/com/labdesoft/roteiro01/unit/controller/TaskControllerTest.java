...
public class TaskControllerTest {
    ...
    public void getAllTasks() throws Exception {
        Task task = new Task("Test Task", TaskType.NOVIDADE, LocalDate.now(), 3, Priority.ALTA);
    ...
    public void createTask() throws Exception {
        Task task = new Task("New Task", TaskType.BUG, LocalDate.now(), 5, Priority.MEDIA);
        task.setStatus(TaskStatus.FEITO);
    ...
    public void testUpdateTask() throws Exception {
        Task task = new Task("Updated Task", TaskType.BUG, LocalDate.now(), 5, Priority.BAIXA);
        task.setId(1L);
        task.setStatus(TaskStatus.EM_PROGRESSO);
